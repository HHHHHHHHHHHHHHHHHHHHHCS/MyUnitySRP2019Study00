		...
		Pass
		{
			...
			*/
			...
			float SampleDensity(float3 rayPos)
			{
				...
				float3 normalizedDetailWeights = _DetailWeights / dot(_DetailWeights, float4(1, 1, 1, 1));
				...
				if (baseShapeDensity > 0)
				{
					...
					float4 detailNoise = _DetailNoiseTex.SampleLevel(sampler_DetailNoiseTex, detailSamplePos, mipLevel);
